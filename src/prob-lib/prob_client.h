...
extern ProBState* prob_next_state_short(prob_client_t pc, ProBState s, char *transitiongroup, int *size);
...
extern int prob_get_state_label_short(prob_client_t pc, ProBState s, char *label);
